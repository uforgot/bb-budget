...
export function SummaryCardSlider({
  ...
  const cards = [
    ...
    { label: `${month}${unit} 쓴 지출`, amount: expense, diff: hasPrev ? expense - prevExpense : null, type: 'expense' as const, textColor: 'text-white', bg: '#CFC9FF', img: '/card-expense.png' },
    { label: `${month}${unit} 모은 저축`, amount: savings, diff: hasPrev ? savings - prevSavings : null, type: 'savings' as const, textColor: 'text-white', bg: '#4BBEA0', img: '/card-saving.png' },
