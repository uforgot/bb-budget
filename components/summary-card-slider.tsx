...
export function SummaryCardSlider({
  ...
  const cards = [
    ...
    { label: `${month}${unit} 쓴 지출`, amount: expense, diff: hasPrev ? expense - prevExpense : null, type: 'expense' as const, textColor: 'text-white', bg: '#FF70FF', img: '/card-expense.png' },
    { label: `${month}${unit} 모은 저축`, amount: savings, diff: hasPrev ? savings - prevSavings : null, type: 'savings' as const, textColor: 'text-white', bg: '#2dd4bf', img: '/card-saving.png' },
