...
const WeekDayCard = memo(function WeekDayCard({
  ...
  return (
    <div
      ref={registerRef}
      className={`mx-5 mb-3 rounded-[22px] bg-surface dark:bg-gray-800 transition-colors ${highlighted ? 'ring-1 ring-accent-blue/40' : ''}`}
    >
      ...
      {viewMode === 'week' && (
        <>
          <div className="mx-5 mb-3 mt-2 flex gap-3">
            <div className="flex-1 bg-surface dark:bg-gray-800 rounded-[22px] px-4 pt-4 pb-3">
