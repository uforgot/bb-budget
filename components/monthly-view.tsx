            ...
            return (
              ...
              >
                <span className="relative flex items-center justify-center size-6 flex-shrink-0">
                  ...
                  <span className={`relative text-[16px] font-semibold tracking-[-0.01em] tabular-nums leading-none ${isToday ? 'text-white' : 'text-foreground'}`}>
                    {day}
                  </span>
                </span>
        ...
        {weekDays.map(day => {
          ...
          return (
            ...
            >
              ...
              <span className="mt-1 text-[16px] font-semibold tracking-[-0.01em] tabular-nums">{day}</span>
            </button>
          )
        })}
      </div>
