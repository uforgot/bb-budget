        ...
        <>
          <div className="mx-5 mb-3 mt-4 flex gap-3">
            <div className="flex-1 bg-surface rounded-[22px] px-4 pt-4 pb-3">
              ...
              <p className="text-[20px] font-bold tabular-nums" style={{ color: semanticColors.expense, letterSpacing: '-0.0625em' }}>₩{weekExpense.toLocaleString()}</p>
            </div>
            <div className="flex-1 bg-surface rounded-[22px] px-4 pt-4 pb-3">
              <p className="text-[14px] font-semibold text-foreground mb-0">주간 수입</p>
              <p className="text-[20px] font-bold tabular-nums" style={{ color: semanticColors.income, letterSpacing: '-0.0625em' }}>₩{weekIncome.toLocaleString()}</p>
            </div>
          </div>
