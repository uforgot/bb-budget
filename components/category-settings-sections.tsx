    ...
    <div className="rounded-[22px] bg-surface border border-border/50 overflow-hidden">
      {parents.map((parent, index) => (
        <button
          ...
          className={`relative w-full flex items-center gap-3 px-4 py-2 transition-all duration-200 ease-out select-none ${
        ...
        >
          ...
          {editMode ? (
            <>
              <span className="flex items-center justify-center w-11 self-stretch -my-1 border-l border-border/50 text-muted-foreground/55 flex-shrink-0">
