...
export function AddTransactionModal({ open, initialDate, editTransaction, onClose, onSave }: AddTransactionModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 overscroll-none">
      ...
      <div
        className="absolute inset-x-0 bottom-0 flex flex-col bg-[#f9fafb] dark:bg-surface"
        style={{
      ...
      <div ref={scrollRef} className="flex-1 overflow-y-auto overscroll-contain">
        <div className="w-full max-w-md mx-auto px-5 pt-6 pb-4">
          ...
          <div className="mb-3 rounded-[22px] overflow-visible bg-muted">
            ...
            />
            <div className="border-t border-[#e5e7eb] dark:border-white/12 mx-4" />
      ...
      {/* 하단 버튼 영역 */}
      <div className="w-full px-4 pt-3 flex-shrink-0 bg-[#f9fafb] dark:bg-surface" style={{ paddingBottom: 'max(28px, env(safe-area-inset-bottom, 28px))' }}>
