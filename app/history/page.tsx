        ...
        {Object.keys(grouped).length === 0 ? (
          ...
          <div className="flex flex-col gap-3">
            {Object.entries(grouped).map(([label, items]) => {
              ...
              return (
                <div key={label} className="">
                  <div className="flex items-center justify-between px-3 py-4 bg-surface rounded-[18px]">
                    <button onClick={() => setWeekOffset(w => w - 1)} className="text-muted-foreground p-1">
