        ...
        <div className="flex gap-3 mt-8 pb-10">
          {addingRoot ? (
            <div className="flex items-center gap-2 flex-1">
              ...
              />
              <button onClick={handleAddRoot} className="px-4 py-3 bg-muted text-muted-foreground rounded-[18px] text-sm font-medium">추가</button>
            ...
            <>
              <button
                ...
                className="flex-1 py-3 rounded-[18px] bg-muted text-sm font-medium text-muted-foreground"
              >
                추가
              </button>
            </>
