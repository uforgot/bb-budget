                  ...
                  {([
                    ...
                    return (
                      <button
                        ...
                        className={`relative flex-1 h-11 text-[13px] font-semibold transition-colors ${active ? 'z-20 -mb-[1px] rounded-t-[22px] bg-surface text-foreground' : 'z-10 rounded-t-[18px] bg-surface/55 text-muted-foreground'}`}
                      >
                        {label}
                      </button>
                    )
