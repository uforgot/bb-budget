              ...
              <>
                <ResponsiveContainer width="100%" height={200}>
                  <BarChart data={monthlyAssets} margin={{ left: 0, right: 0, top: 8, bottom: 0 }}>
                      ...
                      content={({ active, payload, label }) => {
                        ...
                        return (
                          <div className="bg-background rounded-lg px-3 py-2">
                            ...
                            <p className="text-xs" style={{ color: '#6A7BFF' }}>잔액 {fmt(cash)}</p>
                    ...
                    />
                    <Bar dataKey="cash" stackId="a" fill="#6A7BFF" radius={[0, 0, 0, 0]} />
                ...
                <div className="flex gap-4 mt-3">
                  <div className="flex items-center gap-1.5">
                    <div className="w-3 h-3 rounded-full" style={{ backgroundColor: '#6A7BFF' }} />
          ...
          <ResponsiveContainer width="100%" height={200}>
            <LineChart data={yearlyData} margin={{ left: 10, right: 10, top: 8, bottom: 0 }}>
              ...
              {(trendMode === 'expense' || trendMode === 'all') && (
                <Line type="monotone" dataKey="expense" stroke="#FF4D8A" strokeWidth={2} dot={{ r: 3, fill: '#FF4D8A' }} connectNulls />
              )}
              {(trendMode === 'income' || trendMode === 'all') && (
                <Line type="monotone" dataKey="income" stroke="#6A7BFF" strokeWidth={2} dot={{ r: 3, fill: '#6A7BFF' }} connectNulls />
              )}
            </LineChart>
          </ResponsiveContainer>
        </Card>
