      ...
      <div className="px-5 mt-3">
            ...
            return (
              <div className="flex-1 text-left pr-1">
                <div className="flex items-center gap-1 mb-1">
                  <p className="text-[16px] font-semibold">총자산</p>
                  <button
                    type="button"
        ...
        <Card
          header={() => {
            ...
            return (
              <div className="flex-1 text-left pr-1">
                <div className="flex items-center gap-1 mb-1">
                  <p className="text-[16px] font-semibold">연간 실질 수입 · 지출</p>
                  <button
                    type="button"
          ...
          header={() => {
            ...
            <div className="flex-1 text-left pr-1">
              <div className="flex items-center gap-1 mb-3">
                <p className="text-[16px] font-semibold">지출 카테고리별 분석</p>
        ...
        <Card
          header={() => {
            ...
            <div className="flex-1 text-left pr-1">
              <div className="flex items-center gap-1 mb-3">
                <p className="text-[16px] font-semibold">수입 카테고리별 분석</p>
