              ...
              <div className="flex-1 text-left pr-1">
                <div className="flex items-center gap-1 mb-1">
                  ...
                  <button
                    ...
                    className="w-4 h-4 rounded-full bg-gray-300 dark:bg-muted text-muted-foreground text-[10px] flex items-center justify-center"
                  >?</button>
                </div>
          ...
          header={() => {
            ...
            <div className="flex-1 text-left pr-1">
              <div className="flex items-center gap-1 mb-3">
                ...
                <button type="button" onClick={(e) => { e.stopPropagation(); alert("연간 누적 지출 상위 10개 카테고리의 연간 흐름을 확인하세요.") }} className="w-4 h-4 rounded-full bg-gray-300 dark:bg-muted text-muted-foreground text-[10px] flex items-center justify-center">?</button>
              </div>
          ...
          header={() => {
            ...
            <div className="flex-1 text-left pr-1">
              <div className="flex items-center gap-1 mb-3">
                ...
                <button type="button" onClick={(e) => { e.stopPropagation(); alert("연간 누적 수입 상위 10개 카테고리의 연간 흐름을 확인하세요.") }} className="w-4 h-4 rounded-full bg-gray-300 dark:bg-muted text-muted-foreground text-[10px] flex items-center justify-center">?</button>
              </div>
              <div className="space-y-2">
                {top3.map((cat, i) => (
                  <div key={cat.catId} className="flex items-center justify-between">
